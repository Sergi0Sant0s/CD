...
<div class="chat-container">
  ...
  <div class="row rounded-lg overflow-hidden shadow" >
    <!-- Users box-->
    <div class="col-12 col-xs-12 col-md-5" style="padding: 0; padding-bottom:15px; margin-bottom:20px;">
      <div class="bg-white">

        <div class="px-4 py-2">
          <p class="h5 mb-0 py-1 bg-gray">Canais</p>
        </div>
      ...
      <div class="px-4 py-5 chat-box bg-white" id="messages">
        ...
        <div class="media w-50 mb-3">
          ...
          <div class="media-body ml-3">
            <p class="text-small mb-0 font-weight-bold">Sergio Santos</p>
            <div class="bg-light rounded py-3 px-3 mb-2" >
              <p class="text-small mb-0 text-muted">Test which is a new approach to have all solutions</p>
            </div>
