<div class="chat-container">
    <div class="row rounded-lg overflow-hidden shadow" style="padding: 20px">
        ...
        <div class="col-12 col-xs-12 col-md-4">
            ...
            <div id="ftp-folders"
                style="padding:0 !important; overflow-y: scroll; border: 3px solid white; border-radius:10px">
                <p id="map" style="background-color: white; border: 1px solid gray;border-radius:5px; margin:0;">
                </p>
                <ul></ul>
            </div>
        </div>
        <div class="col-12 col-xs-12 col-md-8 px-0">
            ...
            <div id="ftp-files"
                style="padding:0 !important;overflow-y: auto; border: 3px solid white;border-radius:10px">
                <ul></ul>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <form class="my-2 my-lg-0">
                        ...
                        <h6 style="color:red"><span>Pasta a eliminar: </span><span id="modal-deletefolder-name"></span>
                        </h6>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <form class="my-2 my-lg-0">
                        ...
                        <h6 style="color:red"><span>Ficheiro a eliminar: </span><span id="modal-deletefile-name"></span>
                        </h6>
                    </form>
                </div>
            </div>
