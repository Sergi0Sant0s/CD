...
namespace Api.Data.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        /// <returns></returns>
        public async Task<UserEntity> NewUserAsync(string name, string username, string password, string email, string imagePath)
        {
            try
            {
        ...
        /// <param name="folderPath">Caminho/Diretorio para as pastas</param>
        /// <returns></returns>
        public async Task<UserEntity> UpdateUserAsync(string name, string username, string email, string imagePath)
        {
            try
            {
                var user = await _dataset.SingleOrDefaultAsync(a => a.Username.ToUpper().Equals(username.ToUpper()));
